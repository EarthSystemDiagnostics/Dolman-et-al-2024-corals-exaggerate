...
ggsave(plot = fig_var_ill,
       width = 7, height = 4,
       filename = "production-figures/Fig1bc.tiff")
```
...
fig_ts_srca_ersst <- coral_pairs_once_ann_cal %>% 
  ...
  scale_colour_manual("",
    ...
    labels = c(ERSST = "ERSSTv5", 
               Proxy_STD = expression("Reconstructed SST\n(-0.06 mmol/mol °C"^{-1}*")"), 
...
ggsave(fig_ts_srca_ersst, filename = "figures/fig_ts_srca_ersst.png", height = 9,  width = 9)

ggsave(fig_ts_srca_ersst, filename = "production-figures/FigS1.tiff", height = 9,  width = 9)
```
...
ggsave(plot = fig_S2,
       width = 8, height = 8,
       filename = "production-figures/FigS2.tiff")
...
ggsave(plot = fig_SNR_full_Freq,
       width = 8, height = 4,
       filename = "production-figures/FigS3.tiff")
```
...
ggsave(plot = fig_2ac,
       width = 8, height = 9,
       filename = "production-figures/Fig2ac.tiff")
```
...
ggsave(plot = fig4,
       width = 5, height = 4,
       filename = "production-figures/Fig4.tiff")
```
...
ggsave(plot = fig3,
       width = 5, height = 5,
       filename = "production-figures/Fig3.tiff")
```
...
ggsave(plot = fig_SNR_vs_resids_low,
       width = 7, height = 4,
       filename = "production-figures/FigS4.tiff")
```
...
ggsave(plot = fig_S5,
       width = 9, height = 4,
       filename = "production-figures/FigS5.tiff")
...
ggsave(plot = fig_S6,
       width = 7, height = 4,
       filename = "production-figures/FigS6.tiff")
```
...
ggsave(plot = fig_SNR_dist_SrCa,
       width = 7, height = 4,
       filename = "production-figures/FigS7.tiff")
```
...
ggsave(plot = figS9,
       width = 7, height = 5,
       filename = "production-figures/FigS9.tiff")
